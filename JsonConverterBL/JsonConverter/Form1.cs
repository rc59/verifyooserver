    ...
    public partial class Form1 : Form
    {
        ...
        private  void getDataFromDB()
        {
            if (!string.IsNullOrEmpty(_fileName))
            {
                ...
                sw.WriteLine("TemplateId,GestureId,Name,ModelName,Xdpi,Ydpi,NumEvents,GestureIndex,Instruction,GestureAverageVelocity,GestureLength,GestureTotalStrokesTime,GestureTotalTimeInterval,GestureTotalStrokeArea,GestureMaxPressure,GestureMaxSurface,GestureAvgPressure,GestureAvgSurface,GestureAvgMiddlePressure,GestureAvgMiddleSurface,GestureCommonPressure,GestureCommonSurface,GestureMaxAccX,GestureMaxAccY,GestureMaxAccZ,GestureAvgAccX,GestureAvgAccY,GestureAvgAccZ,GestureAverageStartAcceleration,GestureAccumulatedLengthLinearRegIntercept,GestureAccumulatedLengthLinearRegRSqr,GestureAccumulatedLengthLinearRegSlope,VelocityMax,GestureVelocityPeakMaxIntervalPercentage,GestureVelocityPeakMax,GestureAccelerationPeakIntervalPercentage,GestureAccelerationPeakMax,AverageAcceleration,MaxAcceleration,GestureTotalStrokeAreaMinXMinY,MidOfFirstStrokeVelocity,MidOfFirstStrokeAngle,GestureTotalArea,GestureTotalAreaMinXMinY");
